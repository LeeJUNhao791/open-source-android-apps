...
| :--- | :--- | :---: | :---: | :---: | :---: |
| [**bitcoin-wallet**](https://github.com/schildbach/bitcoin-wallet) | A standalone Bitcoin Wallet app for Android with no centralized backend. | `Java` | `GPL-3.0` | 34 | — |
...
| [**Financius**](https://github.com/mvarnagiris/financius) | A simple application to log and track your expenses and balance. | `Java` | `GPL-2.0` | 625 | — |
...
| [**Money Manager Ex**](https://github.com/moneymanagerex/android-money-manager-ex) | The official Android port of the popular desktop app Money Manager Ex. | `Java` | `GPL-3.0` | 677 | — |
